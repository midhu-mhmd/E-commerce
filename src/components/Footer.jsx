        ...
        <div className="container">
          ...
          <div style={{ 
            ...
            >
              ...
              <p style={{ 
                ...
                Crafting premium natural supplements that harmonize the wisdom of nature 
                with cutting-edge scientific research for your optimal wellness.
              </p>
            </motion.div>
            ...
            >
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                {['Products', 'Science', 'About Us', 'Contact', 'Blog', 'FAQ'].map((link, index) => (
                  <motion.a
                    key={link}
          ...
          >
            <p style={{ color: 'rgba(255, 255, 255, 0.7)', fontSize: '0.9rem' }}>
              © 2024 Bio Thrive. All rights reserved. | Privacy Policy | Terms of Service
            </p>
