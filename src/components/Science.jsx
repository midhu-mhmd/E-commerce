      ...
      <div className="container">
        <div style={{ 
          ...
          >
            ...
            >
              Our commitment to scientific excellence drives every aspect of our product development. 
              Each formula undergoes rigorous testing and validation to ensure maximum efficacy and safety.
            </motion.p>
            ...
            {[...Array(8)].map((_, i) => (
              <motion.div
                ...
                style={{
                  ...
                  width: '6px',
                  height: '6px',
                  background: i % 3 === 0 ? '#66BB6A' : i % 3 === 1 ? '#2E7D32' : '#A5D6A7',
                  borderRadius: '50%',
                  top: `${15 + (i * 10)}%`,
                  left: `${10 + (i * 8)}%`,
        ...
        >
          <div className="text-center mb-12">
            ...
            <p className="body-md text-gray">
              From concept to creation, every step is meticulously planned and executed
            </p>
          </div>

          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '32px' }}>
            {[
              { step: '01', title: 'Research', desc: 'Extensive literature review and ingredient analysis' },
              { step: '02', title: 'Formulation', desc: 'Precise blending and optimization of active compounds' },
              { step: '03', title: 'Testing', desc: 'Rigorous quality control and efficacy validation' },
              { step: '04', title: 'Production', desc: 'Manufacturing in certified, state-of-the-art facilities' }
            ].map((process, index) => (
              <motion.div
                key={index}
                initial={{ opacity: 0, y: 30 }}
