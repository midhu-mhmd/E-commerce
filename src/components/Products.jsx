  ...
  const products = [
    {
      ...
      description:
        "Strengthen your natural defenses with our premium immunity blend.",
    },
    {
      id: 2,
      ...
      description:
        "Natural energy support for sustained vitality throughout your day.",
    },
    {
      id: 3,
      name: "Calm & Balance",
      ...
      description:
        "Find your center with our carefully crafted stress-relief formula.",
    },
  ];
    ...
    >
      <div className="container">
        ...
        >
          ...
          <h2 className="heading-lg text-primary mb-6">Wellness Solutions</h2>
        ...
        <div className="grid grid-3">
          {products.map((product, index) => (
            ...
            >
              ...
              {/* Product info */}
              <div>
                <h3 className="heading-sm text-primary mb-2">{product.name}</h3>

                <p className="body-sm text-gray mb-4">{product.description}</p>
        ...
        >
          <p className="body-md text-gray mb-8">
            Can't find what you're looking for? We have many more products in
            our full collection.
          </p>
